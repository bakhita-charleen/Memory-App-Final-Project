        ...
        Column (modifier = Modifier
            ...
            Box(contentAlignment = Alignment.TopCenter){
                ...
                Row (modifier = Modifier.padding(top = 50.dp),
                    ...
                    Image(painter = painterResource(id = R.drawable.img), contentDescription = "mainlog", modifier = Modifier.size(130.dp))
            ...
            Column (modifier = Modifier
                ...
                TextField (
                    ...
                    label= {
                        Text(text = "Key in email", style = MaterialTheme.typography.labelMedium, color=uiColor)
                    },
                ...
                TextField (
                    ...
                    label= {
                        Text(text = " Enter Password", style = MaterialTheme.typography.labelMedium, color=uiColor)
                    },
