...
fun AddProductsScreen(navController: NavHostController) {
    ...
    Column(modifier = Modifier
        ...
        OutlinedTextField(
            value = productName,
            onValueChange = { productName = it },
            label = { Text(text = "Memory  Description", color = Color.DarkGray) },
            keyboardOptions = KeyboardOptions(keyboardType = KeyboardType.Text)
        )
...
//        )
        ...
        Column(
            ...
            Button(
                ...
                Text(text = "Upload Memory", style = MaterialTheme.typography.labelMedium.copy(fontWeight = FontWeight.Medium))
