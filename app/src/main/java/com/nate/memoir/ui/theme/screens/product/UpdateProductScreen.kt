...
fun UpdateProductsScreen(navController: NavHostController, id: String) {
    ...
    Column(modifier = Modifier
        ...
        OutlinedTextField(
            ...
            label = { Text(text = "Update Memory Description", color = Color.DarkGray) },
...
//                }
        ...
        Column(
            ...
            Button(
                ...
                Text(text = "Update Memory", style = MaterialTheme.typography.labelMedium.copy(fontWeight = FontWeight.Medium))
